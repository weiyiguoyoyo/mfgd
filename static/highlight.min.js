...
result:s,text:i});let a=0
;e.innerHTML="<table>"+s.value.split("\n").map((e=>(a++,
`<tr>\n                <td class="line-no"><a id="L${a}" href="#L${a}">${a}</a></td>\n                <td>${e}</td>\n              </tr>`))).join("")+"</table>",
((e,t,n)=>{const i=t?r[t]:n;e.classList.add("hljs"),i&&e.classList.add(i)
})(e,n,s.language),e.result={language:s.language,re:s.relevance,
relavance:s.relevance},s.second_best&&(e.second_best={
language:s.second_best.language,re:s.second_best.relevance,
relavance:s.second_best.relevance})}const v=()=>{
v.called||(v.called=!0,z("10.6.0","initHighlighting() is deprecated.  Use highlightAll() instead."),
...
"string"==typeof e&&(e=[e]),e.forEach((e=>{r[e]=t}))}function O(e){const t=R(e)
;return t&&!t.disableAutodetect}function M(e,t){const n=e;s.forEach((e=>{
e[n]&&e[n](t)}))}
